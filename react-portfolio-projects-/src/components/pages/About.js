            ...
            <div id='about' className='container'>
                ...
                <div id='--section-about-me-text' className='row'>
                    <div className='col-lg-6 mx-auto'>
                        <p className='-about-me-text'>Hello hello<span className='my-flags'>🇧🇷🇺🇸</span>  I'm andre, a web developer recent
                            graduated from Rutgers Coding Bootcamp. and i am so happy to be able to share
                            my journey in this little peace of art.
                        </p>
                        ...
                        <p className='-about-me-text'> I have had the opportunity to work on a variety of
